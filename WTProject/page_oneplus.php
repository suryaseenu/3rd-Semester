			...
			<table cellpadding="20" cellspacing="30" border = "0">
				<tr>
					<td id = "shad1" onmouseenter="shadow1()" onmouseleave="noshadow1()">
						<center>
							<h3>Oneplus 5T</h3>
						<img src="op5t.jpg" alt="Oneplus 5T" style = "height: 100%"> <br /> <br /></center>
					...
					<td id = "shad2" onmouseenter="shadow2()" onmouseleave="noshadow2()">
						...
						<center>
							<h3>Oneplus 5</h3>
						<img src="op5.jpg" alt="Oneplus 5" style = "height: 100%"/> <br /> <br /></center>
						<b id="spec"> Specifications: </b><br />
						<ul>
						...
						<label> Price: </label> <b class="green">Rs. 32,999</b><br /><br />
						<button class="cart" onclick="cartAdded()"> Add to Cart </button>
						<a href="comment.php"><button class="comment"> Write A Review </button></a>
					...
					<td id = "shad3" onmouseenter="shadow3()" onmouseleave="noshadow3()">
						...
						<center>
							<h3>Oneplus 3T</h3>
						<img src="3t.jpg" alt="Oneplus 3T" style = "height: 100%"/> <br /> <br /></center>
						<b id="spec"> Specifications: </b><br />
						<ul>
						...
						<label> Price: </label> <b class="green">Rs. 29,999</b><br /><br />
						<button class="cart" onclick="cartAdded()"> Add to Cart </button>
						<a href="comment.php"><button class="comment"> Write A Review </button></a>
				...
				<tr>
					<td id = "shad4" onmouseenter="shadow4()" onmouseleave="noshadow4()">
						...
						<center>
							<h3>Oneplus 3</h3>
						<img src ="op3.jpg" alt= "Oneplus 3" style = "height: 100%"/> <br /> <br /></center>
						<b id="spec"> Specifications: </b><br />
						<ul>
							<li> 5.5 inch Optic AMOLED Display</li>
						...
						<label> Price: </label> <b class="green">Rs. 27,999</b><br /><br />
						<button class="cart" onclick="cartAdded()"> Add to Cart </button>
						<a href="comment.php"><button class="comment"> Write A Review </button></a>
					...
					<td id = "shad5" onmouseenter="shadow5()" onmouseleave="noshadow5()">
						...
						<center>
							<h3>Oneplus 2</h3>
						<img src ="op2.jpg" alt= "Oneplus 2" style = "height: 100%"/> <br /> <br /></center>
						<b id="spec"> Specifications: </b><br />
						<ul>
						...
						<label> Price: </label> <b class="green">Rs. 22,999</b><br /><br />
						<button class="cart" onclick="cartAdded()"> Add to Cart </button>
						<a href="comment.php"><button class="comment"> Write A Review </button></a>
					...
					<td id = "shad6" onmouseenter="shadow6()" onmouseleave="noshadow6()">
						...
						<center>
							<h3>Oneplus One</h3>
						<img src ="opone.jpg" alt= "Oneplus One" style = "height: 100%"/> <br /> <br /></center>
						<b id="spec"> Specifications: </b><br />
						<ul>
							<li> 5.5 inch LCD Display</li>
						...
						<label> Price: </label> <b class="green">Rs. 7,500</b><br /><br />
						<button class="cart" onclick="cartAdded()"> Add to Cart </button>
						<a href="comment.php"><button class="comment"> Write A Review </button></a>
